      ...
      <div class="page-inner">
        <div class="sections">
          <section class="section">
            <h1>About Decap CMS</h1>
            <p>
              Decap CMS is an Open Source Headless CMS that is easy to
              understand for the end user. There are no distractions and it is
              free. The data from the CMS is saved within your Git repository.
              That means that there is always a backup of all data and the data
              is not stored on third-party servers.
            </p>

            <p>
              It is build by Netlify and now acquired and maintained by PM
              TechHub.
            </p>
            ...
            <p>
              ...
              or
              <a
                href="mailto:contact@frankriezebos.nl?subject=Decap CMS configurator issue/question"
                target="_blank"
                >send me an email</a
              >.
            </p>
